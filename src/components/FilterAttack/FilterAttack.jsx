  ...
  return (
    <div>
      <Grid
        ...
        alignItems="center"
      >
      {props.handleData2 === "" ? "" : props.handleData2 === true ? "" : props.initialPokeSlider.filter(pokemon => pokemon.attack >= props.handleData[0] && pokemon.attack <= props.handleData[1]).map(filteredPokemon => (
